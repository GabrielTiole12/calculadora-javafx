...
public class Teclado extends GridPane implements Consumer<String> {
	...
	private Botao botaoMaisOuMenos = new Botao("±", this, "escuro");
	private Botao botaoPorCento = new Botao("%", this, "escuro");
	...
	private Botao botaoSoma = new Botao("+", this, "operacao");
	
	private Botao botao0 = new Botao("0", this, "duplo", "arredondar-e");
	private Botao botaoVirg = new Botao(",", this);
	private Botao botaoResultado = new Botao("=", this, "operacao");
	...
	public Teclado() {
		...
		add(botaoAC, 0, 0);
		add(botaoMaisOuMenos, 1, 0);
		add(botaoPorCento, 2, 0);
		add(botaoDiv, 3, 0);
